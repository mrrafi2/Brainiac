...
export default function BlogDetails() {
  ...
  return (
    <div className="container p-4 ">
      ...
      <img src={blogP2} alt="Blog Thumbnail" className="img-fluid mb-3 blog-img" />
      ...
      <div className=" mb-5 blog-content" dangerouslySetInnerHTML={{ __html: blog.content }} style={{color: darkMode ? "#ddd" : "#333" }} />
