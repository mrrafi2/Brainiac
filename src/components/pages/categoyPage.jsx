...
import Blog from "../blog"; // Using Blog component that updates seen count
...
export default function CategoryPage() {
  ...
  return (
    <>
      {/* Pagination Controls */}
      <div className="pagination-container d-flex justify-content-start mt-4 ms-4" style={{ fontSize: "9px" }}>
        <nav>
