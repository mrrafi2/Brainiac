...
export default function SearchBar() {
  ...
  useEffect(() => {
    if (showOverlay && containerRef.current) {
      ...
      // Determine fixed height based on window width.
      const overlayHeight = window.innerWidth < 768 ? "50vh" : "60vh";

      setOverlayStyle({
        position: "fixed",
        top: rect.bottom + 10, // 10px gap below the search bar
        left: rect.left,
        width: rect.width,
        height: overlayHeight, // Set a fixed height so it becomes scrollable
        background: "#1a1a1a",
        borderRadius: "12px",
  ...
  return (
    <div className="search-wrapper" ref={containerRef}>
      ...
      <style>{`
        ...
        /* Search Bar Container: Glass-like futuristic style */
        .search-bar {
          display: flex;
        ...
        @media (max-width: 780px) {
          ...
          /* For mobile, force overlay height to 50vh */
          .overlay {
